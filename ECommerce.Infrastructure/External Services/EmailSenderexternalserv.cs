...
using ECommerce.Core.ServicesConstracts.Email; // Namespace for network credentials and related functionality.

namespace ASPNETCoreIdentityDemo.Services
{
    public class EmailSenderexternalserv : IEmailSenderServiceexternalserv
    {
        // Configuration property to access application settings.
        private readonly IConfiguration _configuration;

        // Constructor that injects the configuration dependency.
        public EmailSenderexternalserv(IConfiguration configuration)
        {
